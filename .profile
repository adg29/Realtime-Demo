...
alias sub_love_who='heroku run curl -F "client_id=$IG_CLIENT_ID"      -F "client_secret=$IG_CLIENT_SECRET"      -F "object=tag"      -F "aspect=media"      -F "object_id=love"      -F "callback_url=$WHO_CALLBACK_HOST/callbacks/geo/love/"      https://api.instagram.com/v1/subscriptions/'
alias sub_nyc_who='heroku run curl -F "client_id=$IG_CLIENT_ID"      -F "client_secret=$IG_CLIENT_SECRET"      -F "object=tag"      -F "aspect=media"      -F "object_id=nyc"      -F "callback_url=$WHO_CALLBACK_HOST/callbacks/geo/nyc/"      https://api.instagram.com/v1/subscriptions/'
